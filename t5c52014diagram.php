...
// Html fejléc
$h->header("2014. évi T5C5 kocsik");

$h->msgOk("2014. évi T5C5 kocsik átfutási idő diagramja");

$h->btnMenu(array("Vissza a 2014. évi T5C5 kocsikhoz"=>"t5c52014.php",
...
$sql .= "where ev=2014 and jarmutipus ilike 't5c5k2mod' ";
...
$h->infoTableCaptionDiagram("2014. évi T5C5 kocsik átfutási idő diagramja");
echo "<tr>
      <th>Sorszám</th>
      <th>Rendszám</th>
      <th>Dátumok</th>
